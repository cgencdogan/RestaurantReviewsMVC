namespace RestaurantReviews.WebUI.Utils {
    static class PageUtil {
        ...
        public static int PanelReviewShownCount { get; set; } = 10;
        public static int PanelMyReviewShownCount { get; set; } = 10;
        public static int PanelMemberShownCount { get; set; } = 10;
        public static int CategoryShownCount { get; set; } = 10;
        public static int PanelFeatureShownCount { get; set; } = 10;
    }
}